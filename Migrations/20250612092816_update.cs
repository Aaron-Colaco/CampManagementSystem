    ...
    public partial class update : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CategoryId = table.Column<int>(type: "int", maxLength: 30, nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GearAssigned = table.Column<bool>(type: "bit", nullable: false),
                    SizesReq = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClothingSizes = table.Column<int>(type: "int", nullable: true),
                    ShoeSizes = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
